...
// API URL 설정
const BaseURL = "http://ec2-54-180-2-103.ap-northeast-2.compute.amazonaws.com:8080";
...
export const fetchChatLogs = async (
  ...
  const response = await axios.get(`${BaseURL}/api/chat/project/logs/${projectId}/${paging}`, {
    headers: {
