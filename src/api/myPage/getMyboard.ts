...
const getMyboard = async (page: number): Promise<BoardDetails[] | null> => {
  const BASE_URL =
    "http://ec2-54-180-2-103.ap-northeast-2.compute.amazonaws.com:8080/api/board/myList/";
