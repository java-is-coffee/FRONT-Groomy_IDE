...
import styles from "../../../styles/project/dropdown/projectCardDropdown.module.css";
...
const ProjectCardDropdown: React.FC<ProjectCardDropdownProps> = ({
  ...
  return (
    <div className={styles["project-card-dropdown"]} ref={ref}>
      <button onClick={() => setIsOpen(!isOpen)}>
        <MdMoreHoriz size={"20px"} color="#646E7D" />
      </button>
      {isOpen && (
        <div className={styles["project-card-dropdown-menu"]}>
          {/* 프로젝트 수정 페이지 구현 예정 */}
